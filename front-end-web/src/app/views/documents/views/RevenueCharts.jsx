...
export default function RevenueCharts() {
  ...
  const getRevenueYear = async () => {
    setDefault();
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/admin/dashboard/transaction/getRevenueYear`
    );
    console.log(response.data);
    const list = response.data;
    let xAxisList = [];
  ...
  const getRevenueMonth = async () => {
    setDefault();
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/admin/dashboard/transaction/getRevenueMonth/${year}`
    );
    console.log(response.data);
    const list = response.data;
    let xAxisList = [];
  ...
  const getRevenueDay = async () => {
    setDefault();
    const response = await axios.get(
      `${process.env.REACT_APP_API_URL}/admin/dashboard/transaction/getRevenueDay/${year}/${month}`
    );
    console.log(response.data);
    const list = response.data;
    let xAxisList = [];
  ...
  return (
    <Box sx={{ padding: 3, display: 'flex' }}>
      <Box sx={{}}>
        <Typography sx={{ fontSize: 18, fontWeight: 'bold' }}>Doanh thu</Typography>
