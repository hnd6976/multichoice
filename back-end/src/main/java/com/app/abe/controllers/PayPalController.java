...
public class PayPalController {
    ...
    public String generateAccessToken() {
        String auth = this.getAuth(
                "ARYNXPJdhAhg9m5qeEHCqEONwnddmcr4Snh2OQ5vId-T3s3ofXJHc-5Z2HTg1O4I3fgoKliMCq5EnAZB",
                "EDAjE1lpyOyfUM0PIDWxApTX8daBDRyeW0mfWwAZdUsDM0Xb57wwT-q-00isble7jRUe48YuVL_bYOHR"
        );
    ...
    @RequestMapping(value="/api/orders/{amount}", method = RequestMethod.POST)
    @CrossOrigin
    public Object createOrder(@PathVariable("amount") int amount) {
        String accessToken = generateAccessToken();
        RestTemplate restTemplate = new RestTemplate();
